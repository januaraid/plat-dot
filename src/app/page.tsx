  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link 
          href="/items"
          className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 group cursor-pointer"
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">アイテム管理</h3>
          <p className="text-gray-600 text-sm">
            持ち物を写真付きで登録し、カテゴリやフォルダで整理できます
          </p>
        </Link>

        <div className="bg-white p-6 rounded-lg shadow-sm opacity-60 cursor-not-allowed">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-purple-600 transition-colors">画像管理</h3>
          <p className="text-gray-600 text-sm">
