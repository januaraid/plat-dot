        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          {loading ? (
            <div className="col-span-full text-center py-8">
              ...
              <p className="text-gray-600 mt-2">統計情報を読み込んでいます...</p>
            </div>
          ) : error ? (
            <div className="col-span-full text-center py-8">
            ...
            <>
              <div className="bg-white p-6 rounded-lg shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">アイテム数</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">フォルダ数</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">画像数</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">AI使用回数</p>
                    <p className="text-2xl font-semibold text-gray-900">{stats.aiUsageCount}</p>
                  </div>
                </div>
              </div>
            </>
